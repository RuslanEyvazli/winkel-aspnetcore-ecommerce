...
namespace WINKEL_ECOMMERCE.Migrations
{
    ...
    partial class WINKEL_ApplicationDbContextModelSnapshot : ModelSnapshot
    {
...
<<<<<<< HEAD
            modelBuilder.Entity("WINKEL_ECOMMERCE.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
...
>>>>>>> b9795eb545a5c97e33d4e33e1211f5ef04577782
            modelBuilder.Entity("WINKEL_ECOMMERCE.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
...
>>>>>>> b9795eb545a5c97e33d4e33e1211f5ef04577782
            ...
            modelBuilder.Entity("WINKEL_ECOMMERCE.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WINKEL_ECOMMERCE.Models.PostTags", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WINKEL_ECOMMERCE.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WINKEL_ECOMMERCE.Models.Comment", b =>
                {
                    b.HasOne("WINKEL_ECOMMERCE.Models.AppUser", "AppUser")
                        .WithMany("Comments")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WINKEL_ECOMMERCE.Models.Comment", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WINKEL_ECOMMERCE.Models.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("WINKEL_ECOMMERCE.Models.PostTags", b =>
                {
                    ...
                    b.HasOne("WINKEL_ECOMMERCE.Models.Tag", "Tag")
                        .WithMany("PostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
